...
import _stemcode
from _stemcode.outcomes import TEST_OUTCOME
...
def getfslineno(obj):
    ...
    if hasattr(obj, 'place_as'):
        obj = obj.place_as
    fslineno = _stemcode._code.getfslineno(obj)
...
def _setup_collect_fakemodule():
    ...
    import stemcode
    stemcode.collect = ModuleType('stemcode.collect')
    stemcode.collect.__all__ = []  # used for setns
    for attr in COLLECT_FAKEMODULE_ATTRIBUTES:
        setattr(stemcode.collect, attr, getattr(stemcode, attr))
